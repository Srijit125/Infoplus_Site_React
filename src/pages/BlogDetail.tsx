        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="text-center mt-10">
              <Link
                to="/blog"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full text-white text-[15px] font-bold transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(235,155,61,0.50)]"
