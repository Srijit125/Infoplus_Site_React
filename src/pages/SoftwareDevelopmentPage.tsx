          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <ScrollReveal direction="right" duration={700} delay={120}>
              <div className="bg-[#ffffff] border border-[rgba(13,17,45,0.08)] rounded-3xl p-8">
                ...
                <div className="grid grid-cols-1 min-[425px]:grid-cols-2 gap-3 mb-8">
                  ...
                  >
                    <div style={{ direction: "ltr" }}>
                      ...
                      <div className="flex items-center gap-4 mb-5">
                        ...
                        <h2 className="text-[22px] lg:text-[32px] font-bold text-[#111] leading-tight mb-0">
                          {svc.title}
                        </h2>
                      </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-8 lg:mb-14">
              ...
              <h2 className="text-[22px] lg:text-[36px] font-bold text-white mt-3">
                How To Engage?
              </h2>
                ...
                >
                  <div className="relative h-full flex flex-col bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/8 hover:border-[#EB9B3D]/40 transition-all duration-300 group">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <span className="text-[20px] lg:text-[28px] font-black text-white/10 leading-none">
                        {step}
                      </span>
                    </div>
