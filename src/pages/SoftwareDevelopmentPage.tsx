      ...
      >
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center px-8 py-3.5 rounded-xl border border-white/30 text-white font-semibold text-[15px] hover:bg-white/10 transition-colors cursor-pointer"
          >
            Explore Services
          </button>
        </div>
