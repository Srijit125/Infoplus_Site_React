        ...
        <div className="container mx-auto px-6 max-w-7xl">
                ...
                <div className="p-10 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full text-white text-[15px] font-bold transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(235,155,61,0.50)] group/btn"
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-24">
              ...
              <button
                onClick={clearFilters}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full text-white text-[15px] font-bold transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(235,155,61,0.50)] cursor-pointer"
                style={{ background: "linear-gradient(135deg, #EB9B3D 0%, #DA4D33 100%)" }}
              >
                Clear All Filters
              </button>
