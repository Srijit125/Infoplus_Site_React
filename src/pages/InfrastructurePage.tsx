            ...
            <div className="lg:col-span-2">
              <ScrollReveal direction="right" duration={700} delay={150}>
                <div className="bg-[#ffffff] border border-[rgba(13,17,45,0.08)] rounded-3xl p-8">
                  <p className="text-[11px] font-bold uppercase tracking-widest text-[#EB9B3D] mb-0">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className={`flex items-center justify-between gap-4 py-4 ${i < 2 ? "border-b border-[rgba(13,17,45,0.08)]" : ""}`}
                      style={{ animation: `revealFade 500ms ease ${i * 120 + 200}ms both` }}
                    >
                      <p className="text-[14px] text-[#444] leading-snug mb-0">{label}</p>
                      <p className="text-[22px] font-black text-[#111] shrink-0 mb-0">{value}</p>
                    </div>
                  ))}
                </div>
              </ScrollReveal>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-6 lg:mb-12">
              ...
              <h2 className="text-[22px] lg:text-[36px] font-bold text-white mt-2">Key Benefits</h2>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-8 lg:mb-14">
              ...
              <h2 className="text-[22px] lg:text-[36px] font-bold text-[#111] mt-2">Our Services</h2>
