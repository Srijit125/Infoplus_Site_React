                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {["Detect", "Avoid", "Heal", "Remediate"].map(
                      (action, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-2 bg-white border border-[rgba(13,17,45,0.08)] rounded-lg px-3 py-2"
                          style={{
                            animation: `revealFade 400ms ease ${i * 80 + 300}ms both`,
                          }}
                        >
                          <Zap className="w-3.5 h-3.5 text-[#EB9B3D] shrink-0" />
            ...
            {OUTCOMES.map(
              (
                ...
                <ScrollReveal
                  ...
                  delay={80}
                >
                  <div className="group bg-white/5 border border-white/8 rounded-2xl p-8 hover:border-[#EB9B3D]/30 hover:bg-white/7 transition-all duration-300 relative overflow-hidden h-full">
                    <div
                    ...
                    <div className="relative z-10">
                      <div className="w-12 h-12 rounded-xl bg-linear-to-br from-[#EB9B3D] to-[#DA4D33] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        <OIcon className="w-5 h-5 text-white" strokeWidth={1.6} />
                      </div>
                      ...
                      <div className="space-y-2">
                        {bullets.map((b, j) => (
                          ...
                          >
                            <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-[#EB9B3D]" />
                            {b}
                          </div>
                        ))}
                      </div>
            ...
            {PILLARS.map(({ icon: PIcon, title, desc }, i) => (
              ...
              >
                <div className="group flex items-start gap-4 bg-[#ffffff] border border-[rgba(13,17,45,0.08)] rounded-xl p-5 hover:bg-white hover:border-[#EB9B3D]/30 hover:shadow-[0_8px_24px_-4px_rgba(235,155,61,0.10)] transition-all duration-300">
                  ...
                  <div>
                    <h3 className="text-[14.5px] font-bold text-[#111] mb-1.5 group-hover:text-[#EB9B3D] transition-colors leading-snug">
                      {title}
                    </h3>
              ...
              <div className="space-y-3">
                {AUTO_BENEFITS.map((benefit, i) => (
                  <ScrollReveal
                    ...
                    duration={600}
                  >
                    <div className="flex items-center gap-3 bg-white/5 border border-white/8 rounded-xl px-5 py-3.5 hover:bg-white/8 hover:border-[#EB9B3D]/30 transition-all duration-200 group">
                      <CheckCircle2 className="w-4 h-4 text-[#EB9B3D] shrink-0 group-hover:text-[#DA4D33] transition-colors" />
              ...
              <ScrollReveal direction="right" delay={100} duration={600}>
                <div className="flex flex-wrap gap-2.5">
                  {AUTO_TOOLS.map((tool, i) => (
                    <span
                      key={i}
                      className="px-3.5 py-2 rounded-xl bg-[#EB9B3D]/10 border border-[#EB9B3D]/30 text-[12px] font-semibold text-[#EB9B3D] cursor-default"
                      style={{
