...
const COOKIE_TYPES = [
  ...
  {
    icon: Settings2,
    gradient: "from-[#c2410c] to-[#f85d37]",
    accent: "#f85d37",
    cardBg: "#fff8f6",
    cardBorder: "#fde0d6",
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="py-20 bg-[#f8f5ff] relative overflow-hidden -mt-10 rounded-t-[3rem] z-20">
        <div className="absolute top-0 right-0 w-105 h-105 rounded-full bg-[#ecdaff] opacity-50 blur-[100px] pointer-events-none" />
        <div
            ...
            {COOKIE_TYPES.map((ct, i) => {
              ...
              return (
                <ScrollReveal key={ct.title} variant="card" delay={i * 100}>
                  <div
                    className="group h-full rounded-2xl p-7 border hover:shadow-[0_12px_40px_-8px_rgba(97,40,166,0.13)] hover:-translate-y-1 transition-all duration-300"
      ...
      <section className="py-24 bg-[#f8f5ff] relative overflow-hidden">
        <div className="absolute top-0 left-0 w-100 h-100 rounded-full bg-[#ecdaff] opacity-40 blur-[120px] pointer-events-none" />
        <div
          className="absolute inset-0 opacity-[0.025] pointer-events-none"
          style={{ backgroundImage: "radial-gradient(circle, #6128a6 1px, transparent 1px)", backgroundSize: "28px 28px" }}
        />
            ...
            {FIRST_PARTY.map((cookie, i) => {
              ...
              return (
                <ScrollReveal key={cookie.name} direction="left" delay={i * 80}>
                  <div className="group flex items-center gap-5 bg-white border border-[#e8e0f7] rounded-2xl px-6 py-5 hover:border-[#6128a6]/35 hover:shadow-[0_8px_32px_rgba(97,40,166,0.10)] transition-all duration-300">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-[#6128a6]/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                      <FIcon className="w-5 h-5 text-[#6128a6]" />
                    </div>
