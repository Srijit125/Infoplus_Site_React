...
export const industries: Industry[] = [
  ...
  { label: "Transport", icon: Rocket },
  { label: "Education", icon: FileText },
  { label: "Retail", icon: Target },
  { label: "Media & Publishing", icon: Monitor },
  { label: "Smart Parking", icon: MapPin },
  { label: "Real Estate", icon: Briefcase },
  { label: "Healthcare", icon: HeartHandshake },
  { label: "Agriculture", icon: TrendingUp },
  { label: "Energy Sector", icon: Shield },
  { label: "Finance and Banking", icon: PieChart },
  { label: "Telecom", icon: Phone },
  { label: "Automotive", icon: CheckCircle2 },
];
