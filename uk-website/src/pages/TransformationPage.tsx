...
import {
  Settings, Users, Zap, Globe, Network,
  Server, RefreshCcw, CheckCircle2, ArrowRight,
  ChevronRight, Target, type LucideIcon,
} from "lucide-react";
import { PageHero } from "../components/shared/PageHero";
import { ScrollReveal } from "../components/ui/ScrollReveal";

type Goal = { num: string; icon: LucideIcon; gradient: string; title: string; desc: string };
type Pillar = { label: string; desc: string; gradient: string; icon: LucideIcon };
...
const PILLARS: Pillar[] = [
  { label: "Information", desc: "Unifying data across the enterprise for a single source of truth and intelligent decision-making", gradient: "from-[#381f55] to-[#6128a6]", icon: Server },
  { label: "Process", desc: "Streamlining workflows with intelligent automation and smart orchestration layers", gradient: "from-[#9a2600] to-[#f85d37]", icon: Settings },
  { label: "Work", desc: "Modernising how teams collaborate, deliver outcomes, and continuously innovate together", gradient: "from-[#0f766e] to-[#14b8a6]", icon: Zap },
  { label: "People", desc: "Building digital literacy and agile mindsets throughout every layer of the organisation", gradient: "from-[#1e3a8a] to-[#3b82f6]", icon: Users },
];

const STRATEGY_STEPS = [
  { title: "Digital Maturity Assessment", desc: "Perform a Digital Maturity Assessment against five key areas: Vision, Culture, Adoption, Execution, and Growth." },
  { title: "Provide Recommendations", desc: "Provide clear, prioritised recommendations based on the \"Digital Maturity Assessment Report\" findings." },
  { title: "Develop a Digital Strategy", desc: "Develop a comprehensive Digital Strategy considering the above recommendations and business context." },
  { title: "Build a Delivery Team", desc: "Assemble and onboard a dedicated team to deliver the agreed digital strategy and roadmap." },
  { title: "Tribe Delivery Model", desc: "The tribe works closely with the client, based on the agreed resourcing and collaboration model." },
  { title: "Validate & Scale", desc: "Validate that the enterprise is an Agile Enterprise by creating a sustainable Digital Core and penetrating Digital Literacy." },
];
      ...
      >
        ...
        <div className="mt-10 flex items-center justify-center">
          <span className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 border border-white/20 text-white/70 text-[12px] font-semibold">
            <span className="w-6 h-6 rounded-full bg-[#f85d37] flex items-center justify-center text-[10px] font-black text-white">20</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left" duration={720}>
              ...
              <h2 className="text-[34px] font-bold text-[#111] mt-3 leading-tight mb-5">
                Digital is Not a Tool.<br />
                <span className="text-[#6128a6]">It's an Organisation-Wide Mindset.</span>
              </h2>
              <p className="text-[15.5px] text-[#555] leading-[1.85] mb-4">
                Our Generation Z engineers in the digital transformation team strongly believe that
                for today's enterprise, adapting to the latest technologies is not enough — it's
                about using "digital" across the entire organisation. We enable digital across the
                world by integrating Information, Process, Work, and People.
              </p>
              <p className="text-[15.5px] text-[#555] leading-[1.85]">
                It is a known fact that transformations are hard, and digital ones are even harder.
                But we have carefully devised 20 success factors to make Digital Transformations
                  ...
                  <div className="space-y-3 mb-7">
                    {MATURITY_AREAS.map((area, i) => (
                      <div
                        ...
                        style={{ animation: `revealFade 400ms ease ${i * 90 + 200}ms both` }}
                      >
                        <div
                          className="h-2 rounded-full bg-linear-to-r from-[#6128a6] to-[#aa3bff] transition-all duration-300"
                          style={{ width: `${100 - i * 8}%` }}
                        />
                        <span className="text-[13px] text-white/65 font-medium shrink-0">{area}</span>
                      </div>
                    ))}
                  </div>
                  <div className="border-t border-white/10 pt-6 text-center">
                    <p className="text-[32px] font-black text-white leading-none">20</p>
                    <p className="text-[12px] text-white/35 mt-1">Transformation Success Factors</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-12">
              ...
              <p className="text-[15px] text-white/45 max-w-xl mx-auto mt-4">
                We enable digital across the world by integrating Information, Process, Work, and People.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {PILLARS.map(({ label, desc, gradient, icon: PIcon }, i) => (
              <ScrollReveal key={i} direction="up" variant="card" delay={i * 100}>
                <div className="group bg-white/5 border border-white/8 rounded-2xl p-7 hover:bg-white/8 hover:border-[#6128a6]/35 transition-all duration-300 h-full text-center flex flex-col items-center">
                  ...
                  <h3 className="text-[18px] font-black text-white mb-3">{label}</h3>
                  <p className="text-[13px] text-white/50 leading-relaxed flex-1">{desc}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-14">
              ...
              <h2 className="text-[36px] font-bold text-[#111] mt-2">Our Top 5 Goals</h2>
            </div>
          </ScrollReveal>
                  ...
                  <div className="group bg-white border border-[#e5e4e7] rounded-2xl overflow-hidden hover:border-[#6128a6]/25 hover:shadow-[0_16px_48px_-8px_rgba(97,40,166,0.10)] hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <div className="p-7 flex flex-col sm:flex-row gap-5 items-start">
                      ...
                      <div className="shrink-0 flex items-center gap-4">
                        <div className={`w-13 h-13 rounded-2xl bg-linear-to-br ${gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-[120px]">
              <ScrollReveal direction="left" duration={720}>
                ...
                <h2 className="text-[34px] font-bold text-[#111] mt-3 leading-tight mb-5">
                  Our Digital<br />
                  <span className="text-[#6128a6]">Transformation Strategy</span>
                </h2>
                <p className="text-[15.5px] text-[#555] leading-[1.85]">
                  A proven six-step approach to make your digital transformation successful — from
                  initial assessment through to validated, scalable execution.
                </p>
            ...
            <div className="relative">
              ...
              <div className="space-y-3">
                {STRATEGY_STEPS.map(({ title, desc }, i) => (
                  <ScrollReveal key={i} direction="right" delay={i * 100} duration={660}>
            ...
            <div className="bg-linear-to-br from-[#0d0517] to-[#381f55] rounded-3xl p-14 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-[36px] md:text-[42px] font-bold mb-4 leading-tight">
                  Transform Your Enterprise.<br className="hidden md:block" />
                  Lead the Digital Era.
                </h2>
                <p className="text-[16px] text-white/55 max-w-2xl mx-auto mb-10 leading-relaxed">
                  Partner with Infoplus Technologies UK Ltd to drive a successful digital
                  transformation — guided by 20 proven success factors and our Generation Z engineers.
                </p>
