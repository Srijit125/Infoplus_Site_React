...
import {
  BarChart2, Database, Layers, Target, Search,
  CheckCircle2, ArrowRight, ChevronRight,
  Eye, Zap, type LucideIcon,
} from "lucide-react";
...
const DATA_STEPS = [
  { num: "01", title: "Identify Business Objectives", desc: "Define the business problems and goals that data can effectively solve." },
  { num: "02", title: "Identify Key Stakeholders", desc: "Align with the right people and decision-makers across the organisation." },
  { num: "03", title: "Current State Assessment", desc: "Evaluate existing data capabilities, tools, and infrastructure." },
  { num: "04", title: "Analyse Assessment Report", desc: "Derive actionable insights and findings from the assessment." },
  { num: "05", title: "Prioritise Tasks", desc: "Focus energy on the highest-impact data initiatives first." },
  { num: "06", title: "Define Roadmap", desc: "Build a clear, phased data transformation roadmap with milestones." },
  { num: "07", title: "Develop & Deploy Solutions", desc: "Build and deploy data solutions using an agile, iterative approach." },
  { num: "08", title: "Govern the Ecosystem", desc: "Establish data governance for ongoing quality, compliance, and trust." },
];
...
const DATA_SERVICES: DataService[] = [
  {
    ...
    details: "From initial data strategy through to analytics architecture and governance.",
  },
  {
    icon: Database,
    ...
    details: "Comprehensive analytical methods to surface patterns, trends, and insights from your data.",
  },
  {
    icon: Eye,
    ...
    details: "Interactive BI dashboards and reports that empower every stakeholder to make data-informed decisions.",
  },
  {
    icon: Target,
    ...
    details: "We work with your leadership team to identify and frame the right problems before investing in solutions.",
  },
  {
    icon: Zap,
    ...
    details: "Define your minimum viable product for data initiatives and build a data-first culture organisation-wide.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left" duration={720}>
              ...
              <h2 className="text-[34px] font-bold text-[#111] mt-3 leading-tight mb-5">
                Using Data is No Longer<br />
                <span className="text-[#6128a6]">Limited to Big Companies.</span>
              </h2>
              <p className="text-[15.5px] text-[#555] leading-[1.85] mb-4">
                It is now widespread across most organisations, if not all. Our data team at Infoplus
                Technologies UK Ltd can enormously help clients with data quality standards, choosing
                the right tools, and developing custom data solutions so that customers can take
                better decisions and improve their relationship with clients and partners.
              </p>
              <p className="text-[15.5px] text-[#555] leading-[1.85]">
                We closely work with clients to develop the right data strategy for their businesses
                so that they can evolve continuously. Data solutions will be developed and deployed
                using an agile approach, with robust information, analysis, and insights at every step.
              </p>
            </ScrollReveal>
              ...
              <div className="bg-[#0d0517] rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="border-t border-white/10 pt-5 grid grid-cols-3 gap-3 text-center">
                    {[["Robust", "Information"], ["Deep", "Analysis"], ["Sharp", "Insights"]].map(([v, l], i) => (
                      <div key={i}>
          ...
          <ScrollReveal direction="fade">
            <div className="text-center mb-14">
              ...
              <p className="text-[15px] text-white/45 max-w-2xl mx-auto mt-4">
                A structured, repeatable process to take your data strategy from vision to
                governed, value-generating reality.
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <ScrollReveal direction="fade">
            <div className="text-center mb-14">
              ...
              <h2 className="text-[36px] font-bold text-[#111] mt-2">Our Data Services</h2>
            </div>
          </ScrollReveal>
                  ...
                  <div className="group bg-white border border-[#e5e4e7] rounded-2xl overflow-hidden hover:border-[#6128a6]/25 hover:shadow-[0_16px_48px_-8px_rgba(97,40,166,0.10)] hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <div className="p-6 flex flex-col sm:flex-row gap-5 items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[13.5px] text-[#666] leading-relaxed mb-2">{desc}</p>
                        <p className="text-[12.5px] text-[#888] italic leading-relaxed">{details}</p>
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {DATA_TOOLS.map(({ name, desc }, i) => (
                    ...
                    >
                      ...
                      <p className="text-[14px] font-bold text-white mb-1">{name}</p>
            ...
            <div className="bg-linear-to-br from-[#0d0517] to-[#381f55] rounded-3xl p-14 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-[36px] md:text-[42px] font-bold mb-4 leading-tight">
                  Better Data.<br className="hidden md:block" />
                  Better Decisions.
                </h2>
                <p className="text-[16px] text-white/55 max-w-2xl mx-auto mb-10 leading-relaxed">
                  Partner with Infoplus Technologies UK Ltd to build a robust data strategy that
                  drives real business outcomes — from quality standards to live analytics.
                </p>
